      ...
      {isFranchiseAdmin ? (
        <>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
            <p className="font-condensed text-xs font-bold uppercase tracking-[0.18em] text-slate-500">
              {franchiseSectionTitle}
            </p>
            <p className="mt-2 text-sm text-slate-600">
              {franchiseSectionDescription}
            </p>
          </div>
        ...
        >
          {modalType === "delete" ? (
            ...
            <div className="space-y-4">
              ...
              <FranchiseIdentityFields
                modalType={modalType}
                logoInputRef={logoInputRef}
                onLogoFileChange={handleLogoFileChange}
                logoPreviewUrl={logoPreviewUrl}
                form={form}
                franchiseInitials={franchiseInitials}
                logoUploadError={logoUploadError}
                onOpenLogoPicker={openLogoPicker}
                uploadingLogo={uploadingLogo}
                onClearLogo={clearLogo}
                selectedFranchise={selectedFranchise}
                formatFranchiseId={formatFranchiseId}
